...
<head>
    ...
    <title>Exemplos Negativos</title>
     <!-- Bootstrap CSS -->
  ...
  ?>
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Exemplos Negativos</li>
      </ol>
   </nav>
   <hr>
   <!--fim migalha de pão-->
            ...
            <div class="informacoes">
              ...
              <div class="percepcao-alunos">
                ...
                <div class="item">
                  ...
                  <div class="imagem">
                    <img src="assets/img/exemplosNegativos1.png" alt="">
                  </div>
                </div>
                <div class="item">
                  <h4>ATITUDES DOS ALUNOS SOBRE AS ESTRATÉGIAS ATIVAS DE APRENDIZAGEM</h4>
                  <div class="imagem">
                    <img src="assets/img/exemplosNegativos2.png" alt="">
                  </div>
                </div>
              </div>
            </div>
