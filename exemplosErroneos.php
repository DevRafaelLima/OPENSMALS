...
<head>
    ...
    <title>Aprendendo com exemplos errôneos</title>
     <!-- Bootstrap CSS -->
            ...
            <div class="informacoes">
              ...
              <div class="row">
                <div class="col pontos-positivos">
                  ...
                  <ul>
                    ...
                    <li>Identificar o erro ajudou a evitar que se repetissem na modelagem futura</li>
                    <li>ErrEx ajudou na compreensão dos conceitos aprendidos.</li>
                    <li>No ErrEx, assim como no PBL, as diferentes visões ajudaram na modelagem de diagramas</li>
                  </ul>
                </div>
                <div class="col pontos-negativos">
                  ...
                  <ul>
                    ...
                    <li>ErrEx tem uma etapa de identificação de erro que torna a modelagem difícil</li>
                    <li>ErrEx reduziu a interação entre os membros da equipe</li>
                    <li>Ao aplicar ErrEx, as equipes com muitos membros atrapalharam a modelagem</li>
                  </ul>
                </div>
              </div>
              ...
              <div class="percepcao-alunos">
                ...
                <div class="item">
                  ...
                  <div class="imagem">
                    <img src="assets/img/exemplos-erroneos.png" alt="">
                  </div>
                </div>
              </div>
            </div>
