     ...
     <div class="container" id="escolhendoEstrategia">
        ...
        <div class="row">
                        ...
                        <p>
                          ...
                          <div class="collapse" id="aprendizagemSemelhantes">
                            <div class="card card-body">
                                ...
                                <a href="aprendizagemSemelhante.html" class="btn btn-block">Saiba mais</a>
                            </div>
                          </div>
                    </div>
                        ...
                        <p>
                          ...
                          <div class="collapse" id="serraVaivem">
                            <div class="card card-body">
                                ...
                                <a href="serraVaiVem.html" class="btn btn-block">Saiba mais</a>
                            </div>
                          </div>
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="item">
                    <div class="topo" style=" background-color: #4e937a;">
                        <h3>Aprendendo com exemplos errôneos</h3>
                    </div>
                    <div class="conteudo">
                        <p>
                          ...
                          <div class="collapse" id="erroneos">
                            <div class="card card-body">
                                ...
                                <a href="exemplosErroneos.html" class="btn btn-block">Saiba mais</a>
                            </div>
                          </div>
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="item">
                    <div class="topo" style=" background-color: #4e937a;">
                        <h3>Estratégia baseada em inspeção</h3>
                    </div>
                    <div class="conteudo">
                        <p>
                          ...
                          <div class="collapse" id="estrategia">
                            <div class="card card-body">
                                ...
                                <a href="estrategiaInspecao.html" class="btn btn-block">Saiba mais</a>
                            </div>
                          </div>
                    </div>
                </div>
                        ...
                        <p>
                          ...
                          <div class="collapse" id="multimodal">
                            <div class="card card-body">
                                ...
                                <a href="abordagemMultimodal.html" class="btn btn-block">Saiba mais</a>
                            </div>
                          </div>
                    </div>
                </div>
                        ...
                        <p>
                          ...
                          <div class="collapse" id="exemplosNegativos">
                            <div class="card card-body">
                                ...
                                <a href="ExemplosNegativos.html" class="btn btn-block">Saiba mais</a>
                            </div>
                          </div>
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="item">
                    <div class="topo" style=" background-color: #791e94;">
                        <h3>Método de ensino de trilha dupla PBL + LBL</h3>
                    </div>
                    <div class="conteudo">
                        <p>
                          ...
                          <div class="collapse" id="metodoEnsino">
                            <div class="card card-body">
                                ...
                                <a href="metodoEnsino.html" class="btn btn-block">Saiba mais</a>
                            </div>
                          </div>
                    </div>
                </div>
                        ...
                        <p>
                          ...
                          <div class="collapse" id="exemplosPositivos">
                            <div class="card card-body">
                                ...
                                <a href="exemploPositivo.html" class="btn btn-block">Saiba mais</a>
                            </div>
                          </div>
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="item">
                    <div class="topo" style=" background-color: #4e937a;">
                        <h3>Aprendizagem baseada em problemas (PBL) adaptado</h3>
                    </div>
                    <div class="conteudo">
                        <p>
                          ...
                          <div class="collapse" id="problemasAdaptado">
                            <div class="card card-body">
                                ...
                                <a href="aprendizagemProblemas.html" class="btn btn-block">Saiba mais</a>
                            </div>
                          </div>
                    </div>
                </div>
                        ...
                        <p>
                          ...
                          <div class="collapse" id="square">
                            <div class="card card-body">
                                ...
                                <a href="think.html" class="btn btn-block">Saiba mais</a>
                            </div>
                          </div>
                    </div>
                </div>
