...
<head>
    ...
    <title>Estratégia baseada em inspeção</title>
     <!-- Bootstrap CSS -->
            ...
            <div class="informacoes">
              ...
              <div class="row">
                <div class="col pontos-positivos">
                  ...
                  <b>Aprendizado colaborativo</b>
                  <ul>
                    <li>A colaboração permitiu criar um diagrama com mais detalhes</li>
                    <li>A interação com a equipe permitiu o aprendizado</li>
                    <li>A estratégia permite que os alunos trabalhem em equipe</li>
                  </ul>
                  <b>Estratégia fornece feedback</b>
                  <ul>
                    <li>A estratégia permite receber feedback dos problemas identificados pela outra equipe</li>
                  </ul>
                </div>
                <div class="col pontos-negativos">
                  ...
                  <b>Falta de feedback entre os grupos</b>
                  <ul>
                    <li>Falta de comunicação / interação entre as equipes (modeladores e inspetores)</li>
                  </ul>
                </div>
              </div>
              ...
              <div class="percepcao-alunos">
                ...
                <div class="item">
                  ...
                  <div class="imagem">
                    <img src="assets/img/inpeccao1.png" alt="">
                  </div>
                </div>
                <div class="item">
                  <h4>ATITUDES DOS ALUNOS SOBRE AS ESTRATÉGIAS ATIVAS DE APRENDIZAGEM</h4>
                  <div class="imagem">
                    <img src="assets/img/inpeccao2.png" alt="">
                  </div>
                </div>
              </div>
            </div>
