...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container">
        ...
        <form action="avaliar-estrategia.php" method="GET">
            <input type="number" value="<?= $_GET['cod']?>" name="cod" hidden>
            <div class="form-group row">
                <label for="status_avaliacao" class="col-sm-2 col-form-label">Status da Avaliação: </label>
                <select name="status_estrategia" id="status_estrategia" class="form-control col-sm-2">
                <?php if($estrategia->getStatus() == 0): ?>
                    <option value="0">Não Avaliado</option>
                    <option value="1">Aprovado</option>
                    <option value="2">Não aprovado</option>
                    <option value="3">Necessito de mais informações</option>
                ...
                <label for="comentarioStatus" class="col-sm-2">Comentários sobre a avaliação: </label>
                <textarea name="comentarioStatus" id="comentarioStatus" class="form-control col-sm-6" rows="5"></textarea>
            </div>
